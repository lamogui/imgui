...
// Helpers: Sorting
#ifndef ImQsort
static inline void      ImQsort(void* base, size_t count, size_t size_of_element, int(IMGUI_CDECL *compare_func)(void const*, void const*)) { if (count > 1) IMGUI_STD_FUNC_NAMESPACE::qsort(base, count, size_of_element, compare_func); }
#endif
...
inline void     ImBitArrayClearAllBits(ImU32* arr, int bitcount){ IMGUI_STD_FUNC_NAMESPACE::memset(arr, 0, ImBitArrayGetStorageSizeInBytes(bitcount)); }
...
struct ImBitArray
{
    ...
    void            ClearAllBits()              { IMGUI_STD_FUNC_NAMESPACE::memset(Storage, 0, sizeof(Storage)); }
    void            SetAllBits()                { IMGUI_STD_FUNC_NAMESPACE::memset(Storage, 255, sizeof(Storage)); }
...
struct IMGUI_API ImBitVector
{
    ...
    void            Create(int sz)              { Storage.resize((sz + 31) >> 5); IMGUI_STD_FUNC_NAMESPACE::memset(Storage.Data, 0, (size_t)Storage.Size * sizeof(Storage.Data[0])); }
...
struct ImSpanAllocator
{
    ...
    ImSpanAllocator()                               { IMGUI_STD_FUNC_NAMESPACE::memset(this, 0, sizeof(*this)); }
...
struct ImDrawDataBuilder
{
    ...
    ImDrawDataBuilder()                     { IMGUI_STD_FUNC_NAMESPACE::memset(this, 0, sizeof(*this)); }
};
...
struct IMGUI_API ImGuiComboPreviewData
{
    ...
    ImGuiComboPreviewData() { IMGUI_STD_FUNC_NAMESPACE::memset(this, 0, sizeof(*this)); }
};
...
struct IMGUI_API ImGuiMenuColumns
{
    ...
    ImGuiMenuColumns() { IMGUI_STD_FUNC_NAMESPACE::memset(this, 0, sizeof(*this)); }
...
struct IMGUI_API ImGuiInputTextDeactivatedState
{
    ...
    ImGuiInputTextDeactivatedState()    { IMGUI_STD_FUNC_NAMESPACE::memset(this, 0, sizeof(*this)); }
...
struct IMGUI_API ImGuiInputTextState
{
    ...
    ImGuiInputTextState()                   { IMGUI_STD_FUNC_NAMESPACE::memset(this, 0, sizeof(*this)); }
...
struct ImGuiNextWindowData
{
    ...
    ImGuiNextWindowData()       { IMGUI_STD_FUNC_NAMESPACE::memset(this, 0, sizeof(*this)); }
...
struct ImGuiNextItemData
{
    ...
    ImGuiNextItemData()         { IMGUI_STD_FUNC_NAMESPACE::memset(this, 0, sizeof(*this)); SelectionUserData = -1; }
...
struct ImGuiLastItemData
{
    ...
    ImGuiLastItemData()     { IMGUI_STD_FUNC_NAMESPACE::memset(this, 0, sizeof(*this)); }
};
...
struct IMGUI_API ImGuiStackSizes
{
    ...
    ImGuiStackSizes() { IMGUI_STD_FUNC_NAMESPACE::memset(this, 0, sizeof(*this)); }
...
struct ImGuiPopupData
{
    ...
    ImGuiPopupData()    { IMGUI_STD_FUNC_NAMESPACE::memset(this, 0, sizeof(*this)); ParentNavLayer = OpenFrameCount = -1; }
};
...
struct ImGuiInputEvent
{
    ...
    ImGuiInputEvent() { IMGUI_STD_FUNC_NAMESPACE::memset(this, 0, sizeof(*this)); }
};
...
struct ImGuiListClipperData
{
    ...
    ImGuiListClipperData()          { IMGUI_STD_FUNC_NAMESPACE::memset(this, 0, sizeof(*this)); }
...
struct IMGUI_API ImGuiTypingSelectState
{
    ...
    ImGuiTypingSelectState() { IMGUI_STD_FUNC_NAMESPACE::memset(this, 0, sizeof(*this)); }
...
struct ImGuiOldColumnData
{
    ...
    ImGuiOldColumnData() { IMGUI_STD_FUNC_NAMESPACE::memset(this, 0, sizeof(*this)); }
};
...
struct ImGuiOldColumns
{
    ...
    ImGuiOldColumns()   { IMGUI_STD_FUNC_NAMESPACE::memset(this, 0, sizeof(*this)); }
};
...
struct ImGuiWindowSettings
{
    ...
    ImGuiWindowSettings()       { IMGUI_STD_FUNC_NAMESPACE::memset(this, 0, sizeof(*this)); }
...
struct ImGuiSettingsHandler
{
    ...
    ImGuiSettingsHandler() { IMGUI_STD_FUNC_NAMESPACE::memset(this, 0, sizeof(*this)); }
};
...
struct ImGuiDebugAllocInfo
{
    ...
    ImGuiDebugAllocInfo() { IMGUI_STD_FUNC_NAMESPACE::memset(this, 0, sizeof(*this)); }
};
...
struct ImGuiStackLevelInfo
{
    ...
    ImGuiStackLevelInfo()   { IMGUI_STD_FUNC_NAMESPACE::memset(this, 0, sizeof(*this)); }
};
...
struct ImGuiIDStackTool
{
    ...
    ImGuiIDStackTool()      { IMGUI_STD_FUNC_NAMESPACE::memset(this, 0, sizeof(*this)); CopyToClipboardLastTime = -FLT_MAX; }
};
...
struct ImGuiContextHook
{
    ...
    ImGuiContextHook()          { IMGUI_STD_FUNC_NAMESPACE::memset(this, 0, sizeof(*this)); }
};
...
struct ImGuiContext
{
    ...
    ImGuiContext(ImFontAtlas* shared_font_atlas)
    {
        ...
        IMGUI_STD_FUNC_NAMESPACE::memset(DragDropPayloadBufLocal, 0, sizeof(DragDropPayloadBufLocal));
        ...
        IMGUI_STD_FUNC_NAMESPACE::memset(LocalizationTable, 0, sizeof(LocalizationTable));
        ...
        IMGUI_STD_FUNC_NAMESPACE::memset(FramerateSecPerFrame, 0, sizeof(FramerateSecPerFrame));
        FramerateSecPerFrameIdx = FramerateSecPerFrameCount = 0;
        FramerateSecPerFrameAccum = 0.0f;
        WantCaptureMouseNextFrame = WantCaptureKeyboardNextFrame = WantTextInputNextFrame = -1;
        IMGUI_STD_FUNC_NAMESPACE::memset(TempKeychordName, 0, sizeof(TempKeychordName));
    }
};
...
struct ImGuiTabItem
{
    ...
    ImGuiTabItem()      { IMGUI_STD_FUNC_NAMESPACE::memset(this, 0, sizeof(*this)); LastFrameVisible = LastFrameSelected = -1; RequestedWidth = -1.0f; NameOffset = -1; BeginOrder = IndexDuringLayout = -1; }
};
...
struct IMGUI_API ImGuiTable
{
    ...
    ImGuiTable()                { IMGUI_STD_FUNC_NAMESPACE::memset(this, 0, sizeof(*this)); LastFrameActive = -1; }
...
struct IMGUI_API ImGuiTableTempData
{
    ...
    ImGuiTableTempData()        { IMGUI_STD_FUNC_NAMESPACE::memset(this, 0, sizeof(*this)); LastTimeActive = -1.0f; }
};
...
struct ImGuiTableSettings
{
    ...
    ImGuiTableSettings()        { IMGUI_STD_FUNC_NAMESPACE::memset(this, 0, sizeof(*this)); }
